...
# f = open("2019-06-23-1min.txt","w")
# f = open("2018-04-23-1min.txt","w")
f = open("2017-08-24-1min.txt","w")
...
stream = pybgpstream.BGPStream(
    ...
    # from_time="2019-06-23 07:59:00", until_time="2019-06-23 08:00:00",
    # from_time="2018-04-23 07:59:00", until_time="2018-04-23 08:00:00",
    from_time="2017-08-24 07:59:00", until_time="2017-08-24 08:00:00",
    collectors=["rrc00"],
    record_type="ribs",
    #record_type="updates",
)
